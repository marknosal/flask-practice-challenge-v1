...
with app.app_context():
  ...
  post_1_comment_4 = Comment(commenter='Mark', post_id=post_1.id, content='test post')

  db.session.add_all([post_1_comment_1, post_1_comment_2, post_1_comment_3, post_1_comment_4])
  db.session.commit()
  ...
  post_2_comment_3 = Comment(commenter='Mark', post_id=post_1.id, content='test post')

  db.session.add_all([post_2_comment_1, post_2_comment_2, post_2_comment_3])
  db.session.commit()

  post_3_comment_1 = Comment(commenter="Sara", post_id=post_3.id, content="Cute Dog!")
  post_3_comment_2 = Comment(commenter='Mark', post_id=post_1.id, content='test post')
